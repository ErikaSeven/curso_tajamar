...
export class Formulario {
    ...
    definirManejadores() {
        ...
        //this.domInpApellido.setCustomValidity('Añade tu apellido')  //setcustomvalidity nos sirve para poner el mensaje que queramos
    ...
    presentarAsignaturas(ev) {
        ...
        let topics = CURSOS[ev.target.selectIndex-1].asignaturas
        let HTMLResult = ''
